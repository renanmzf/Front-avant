...
export default function CostAnalysisScreen() {
  const [activeTab, setActiveTab] = useState<TabType>("cost-distribution")
  const { data, chartFilters, setChartFilters } = useCostAnalysisData()
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Controle financeiro completo de todos os custos da construção</p>
      </div>

      <div className="space-y-8">
        <TabNavigation activeTab={activeTab} onTabChange={setActiveTab} className="max-w-2xl mx-auto" />
