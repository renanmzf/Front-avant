...
import type { CostDistribution, ChartFilters } from "../types/cost-analysis"
    ...
    <Card className={`w-full ${className}`}>
      <CardHeader>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <CardTitle className="text-xl font-semibold text-gray-900">Distribuição por Tipo de Custo</CardTitle>
            <CardDescription>Percentual de Material vs Mão de Obra</CardDescription>
          </div>
      ...
      <CardContent>
        <div className="flex flex-col items-center">
          ...
          <div className="text-center mt-4">
            ...
            <div className="text-sm text-gray-600">Total de custos</div>
          </div>
        </div>
      </CardContent>
    </Card>
